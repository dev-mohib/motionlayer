...
export const ShadowIcon : FC<SVGProps<SVGSVGElement>>  = (props) => {
  return (
    <svg {...props} stroke="currentColor" fill="none" strokeWidth="0" viewBox="0 0 24 24" 
    color="white" height="48" width="48" xmlns="http://www.w3.org/2000/svg" style={{color: "white"}}>
        ...
        <path fillRule="evenodd" clipRule="evenodd" d="M2 8V22H16V8H2ZM14 10H4V20H14V10Z" fill="currentColor">
        </path>
